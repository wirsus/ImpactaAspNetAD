    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                ...
                <asp:MultiView
                    ActiveViewIndex="0"
                    ID="criterioPesquisaMultiView"
                    runat="server">
                    <asp:View ID="categoriaView" runat="server">
                        <asp:DropDownList
                            ID="categoriaDropDownList"
        ...
        <div class="row">
            <div class="col-md-12">
                <asp:GridView
                    ...
                    Width="100%"
                    CssClass="table table-bordered table-condensed table-inverse"
                    DataSourceID="produtoPorCategoriaObjectDataSource"
                    runat="server">
                    <Columns>
                        <asp:BoundField DataField="ProductName" HeaderText="Nome" />
                        <asp:BoundField DataField="UnitPrice" HeaderText="Preço" DataFormatString="{0:C2}" />
                ...
                <asp:ObjectDataSource
                    ID="produtoPorFornecedorObjectDataSource"
                    TypeName="Northwind.Repositorios.SqlServer.Ado.ProdutoRepositorio"
